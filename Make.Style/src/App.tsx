...
function App() {
  ...
  const [, setIsTwitterTemplate] = useState(false);
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-[#0f0f0f] text-white' : 'bg-gray-100 text-gray-900'} flex flex-col md:flex-row overflow-hidden`}>
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <div className="flex-1 p-40 overflow-y-auto">
          <div ref={previewRef}>
            <Preview
              selectedSize={selectedSize}
              gradient={gradient}
              ...
              gradientType={gradientType}
              //isTwitterTemplate={isTwitterTemplate}
            />
          </div>
          <ActionButtons 
            onGenerateGradient={() => {
